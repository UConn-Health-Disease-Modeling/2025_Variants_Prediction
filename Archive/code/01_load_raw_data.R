...
# saveRDS(res, "code2/variant_analytical_periods.rds")

lineage_period_df <- readRDS("code2/variant_analytical_periods.rds")
...
# )
# 
# saveRDS(out_list, file = "code2/data3_and_dropped.rds")
...
# # further check on the included total share 
