...
Korea_compress_share <- apply(Korea_fitted, 2, paa_transform, num_segments = 6)
UK_compress_share    <- apply(UK_fitted,    2, paa_transform, num_segments = 6)
...
Korea_compress_share <- apply(Korea_fitted, 2, paa_transform, num_segments = 9)
UK_compress_share    <- apply(UK_fitted,    2, paa_transform, num_segments = 9)
...
Korea_compress_share <- apply(Korea_fitted, 2, paa_transform, num_segments = 12)
UK_compress_share    <- apply(UK_fitted,    2, paa_transform, num_segments = 12)
